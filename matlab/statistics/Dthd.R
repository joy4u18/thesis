...
# load the data
DThdData <- read_excel("E:/GitHub/thesis/matlab/statistics/DthdRanalysis.xlsx")
...
(obj1 <- ggplot(data=DThdData,
                aes( y=DistanceThreshold,x=Id, color=Group,
...
obj3 <- obj2 +labs(x="Participant", y="Distance Threshold (m)")
obj3
...
obj10 <- obj9  + scale_y_continuous(breaks = seq(100,300,100), labels = c("100"= "1", "200"= "2", "300"= "3")) +scale_x_continuous(breaks = seq(1,20,2))
obj10
