...
%             : The script is explicitly for 500ms signals or 5ms with 32 or 64 clicks only
...
if (size(T_outputamp,1)==8)
    ...
    latexinput.tableCaption = 'RMS amplitude values of 10 versions for the left ear recordings in the lecture chamber with  500ms duration signal';
    latexinput.tableLabel = 'RMS_lecture_500ms_left';
    ...
    % latexinput.tableColumnAlignment = 'c';
    % latexinput.tableBorders = 1;
    % latexinput.tableCaption = 'Mean of the RMS amplitude values of  10 versions for the left ear recordings in the lecture chamber with  500ms duration signal';
    % latexinput.tableLabel = 'RMS_mean_lecture_500ms_left';
    % latexinput.makeCompleteLatexDocument = 0;
    % latexoutput=latexTable(latexinput);
