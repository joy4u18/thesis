...
%%%%%%%%%%%%%
% Signaloptions
all_options.signal.signal_filename='ct8ms.wav';
all_options.signal.start_time=0;
all_options.signal.duration=0.064;
all_options.signal.samplerate=16000;
all_options.signal.original_start_time=0;
all_options.signal.original_duration=0.064;
...
all_options.bmm.dcgc.highest_frequency=12000;
