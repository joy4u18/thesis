...
% handles.info.default_start_module_sai='ti2003';  %(VJ 2015 commented this to make ACF default)
handles.info.default_start_module_sai='autocorr';
% handles.info.default_start_module_usermodule='mellin'; %(VJ 2015 commented this to make ACF default)
handles.info.default_start_module_usermodule='pitchstrength';
