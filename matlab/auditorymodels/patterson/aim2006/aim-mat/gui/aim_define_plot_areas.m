...
ra(1)=ra(1)+0.015;            %0.1 ;
if strcmp(handles.screen_modus,'paper')
	ra(2)=ra(2);  % VJ 2014 + 0.8 ;         % initially it was 0.1 by TW2006;
end
if exist('axpos1','var')
 	myaxes1=subplot('Position',[ra(1)+(axpos1(1)*ra(3)) ra(2)+(axpos1(2)*ra(4))+0.06  ra(3)*axpos1(3) ra(4)*axpos1(4)] ); %
...
if exist('axpos4','var')
	myaxes4=subplot('Position',[ra(1)+(axpos4(1)*ra(3))+0.03  ra(2)+(axpos4(2)*ra(4)) ra(3)*axpos4(3) ra(4)*axpos4(4)] ); %VJ2014 +0.03
