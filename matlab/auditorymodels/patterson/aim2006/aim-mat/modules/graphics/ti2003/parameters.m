...
ti2003.is_log=1;  % VJ2014: actually it is "1". Anything else is my change. 
ti2003.time_reversed=0;
ti2003.display_time=0;
ti2003.time_profile_scale=1;
ti2003.plotstyle='surf'; % VJ2014: actually it is "surf". Anything else is my change. 
ti2003.colormap='gray'; % VJ2014: actually it is "gray". Anything else is my change. 
ti2003.colorbar='off';
