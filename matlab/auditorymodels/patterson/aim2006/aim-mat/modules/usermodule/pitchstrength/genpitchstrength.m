...
% for frame_number=nr_frames:nr_frames
	...
	histo=histo+interval_sig;   %% VJ2015: Comment this line to remove  the sum
%     histo= interval_sig;     %% VJ2015 
	% dynamic decrease of all pitch strengthes
	histo=histo*ps_decay_constant;     %% VJ2014: Comment this line to remove  the decay
% 
%         figure(234324)
%     clf
%     plot(histo);
