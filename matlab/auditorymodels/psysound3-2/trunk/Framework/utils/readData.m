...
temp=audioinfo(fH.name);                %VJ 2015

% This is by convention - see help wavread
% fH.samples  = temp(1);
% fH.channels = temp(2);

fH.samples  = temp.TotalSamples;        % VJ 2015
fH.channels = temp.NumChannels;
...
temp1 = audioinfo(fH.name);   %VJ2015
...
fH.data          = []; % no data as yet
fH.sampleRate    = temp1.SampleRate;        % VJ 2015
fH.bitsPerSample = temp1.BitsPerSample;
fH.info = temp1.Title;
